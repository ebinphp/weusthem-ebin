...
<div class="container">
  ...
  <form action="add.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" id="fname" name="con_fname" placeholder="Your First Name.." required>
    ...
    <input type="text" id="con_phone" name="con_phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="000-000-0000" required>
